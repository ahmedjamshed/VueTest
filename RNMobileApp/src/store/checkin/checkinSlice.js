import {
  ...
  export const upsertcheckin = createAsyncThunk("store/upsertcheckin", async (item) => {
    try {
  ...
  export const { addAllCheckins, upsertCheckinLocal, deleteCheckin } = checkinSlice.actions;
